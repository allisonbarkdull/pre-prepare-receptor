...
--base_out_dir <path/to/dir>
    Custom output directory for prepared receptor outputs. Default is "pre_prepare_receptor_outputs" in the working directory. Will create dir if it does not exist.